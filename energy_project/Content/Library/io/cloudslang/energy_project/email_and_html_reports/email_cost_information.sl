        ...
        loop:
          ...
          do:
            io.cloudslang.base.mail.send_mail:
              ...
              - subject: "${'Verbruikskosten stroom voor '+date}"
              - body: |-
                  ${'''
                  <!DOCTYPE html>
                  <html>
                    ...
                    <body>
                      ...
                      <br>
                      Beste '''+user+''', dit zijn de gemaakte kosten voor stroom per uur van gisteren, '''+date+''':<br>
                      <br>
                      ...
                      <table width="100%" cellspacing="2" cellpadding="2" border="0">
                        <tbody>
                          <tr>
                            <td valign="top" bgcolor="#325ca8"><br>
                            </td>
                          </tr>
                        </tbody>
                      </table>
