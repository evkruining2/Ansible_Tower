...
#!               Inputs:
#!               
#!               CredentialName	- The exact name of the Ansible Tower Credential component that you want to lookup the id for (example: "Demo Credentials").
#!               
#!               Output:
#!               
#!               CredentialID		- Value of the "id" property of this Ansible Tower component (integrer).
#!
#! @input CredentialName: The exact Credential name of the Ansible Tower Credential component that you want to lookup the id for (example: "Demo Credential").
#!
    ...
    - Connect_to_Ansible_Tower:
        do:
          io.cloudslang.base.http.http_client_get:
            - url: "${get_sp('AnsibleTowerURL')+'/credentials?name='+CredentialName}"
            - auth_type: basic
