...
#!               Inputs:
#!               
#!               OrgName		- The exact name of the Ansible Tower Organization component that you want to lookup the id for (example: "Demo Organization").
#!               
#!               Output:
#!               
#!               OrgID		- Value of the "id" property of this Ansible Tower component (integrer).
#!
    ...
    - Connect_to_Ansible_Tower:
        do:
          io.cloudslang.base.http.http_client_get:
            - url: "${get_sp('AnsibleTowerURL')+'/organizations?name='+OrgName}"
            - auth_type: basic
