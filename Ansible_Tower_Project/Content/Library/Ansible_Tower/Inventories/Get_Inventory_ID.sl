...
#!               Inputs:
#!               
#!               InventoryName	- The exact name of the Ansible Tower Inventory component that you want to lookup the id for (example: "Demo Inventory").
#!               
#!               Output:
#!               
#!               InventoryID		- Value of the "id" property of this Ansible Tower component (integrer).
#!
#! @input InventoryName: The exact Inventory name of the Ansible Tower Inventory component that you want to lookup the id for (example: "Demo Inventory").
#!
    ...
    - Connect_to_Ansible_Tower:
        do:
          io.cloudslang.base.http.http_client_get:
            - url: "${get_sp('AnsibleTowerURL')+'/inventories?name='+InventoryName}"
            - auth_type: basic
