...
#!               Inputs:
#!               
#!               InventoryID		- The id (integrer) of the Ansible Tower Inventory component that you want to delete (example: "15").
#!               
#!               Output:
#!               
#!               No outputs are generated.
#!
#! @input InventoryID: The id (integer) of the Ansible Tower Inventory component that you want to delete (example: "15").
#!!#
########################################################################################################################
    ...
    - Delete_Inventory:
        do:
          io.cloudslang.base.http.http_client_delete:
            - url: "${get_sp('AnsibleTowerURL')+'/inventories/'+InventoryID+'/'}"
            - auth_type: basic
