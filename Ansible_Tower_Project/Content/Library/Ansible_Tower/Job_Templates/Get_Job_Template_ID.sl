...
#!               Inputs:
#!               
#!               TemplateName	- The exact name of the Ansible Tower Job Template component that you want to lookup the id for (example: "Demo Template").
#!               
#!               Output:
#!               
#!               TemplateID		- Value of the "id" property of this Ansible Tower component (integrer).
#!
#! @input TemplateName: The exact Job Template name of the Ansible Tower Job Template component that you want to lookup the id for (example: "Demo Job Template").
#!
#! @output TemplateID: Value of the "id" property of this Ansible Tower component (integrer).
#!!#
########################################################################################################################
...
flow:
  ...
  workflow:
    ...
    - Connect_to_Ansible_Tower:
        do:
          io.cloudslang.base.http.http_client_get:
            - url: "${get_sp('AnsibleTowerURL')+'/job_templates?name='+TemplateName}"
            - auth_type: basic
    ...
    - Filter_ID_from_JSON:
        ...
        publish:
          - TemplateID: "${return_result.strip('[').strip(']')}"
        navigate:
          - SUCCESS: SUCCESS
          - FAILURE: on_failure
