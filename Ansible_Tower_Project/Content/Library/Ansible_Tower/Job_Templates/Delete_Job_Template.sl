########################################################################################################################
#!!
#! @description: This flow will delete a Job Template object in your Ansible Tower system
#!               
#!               Inputs:
#!               
#!               TemplateID		- The ID (integrer) of the Ansible Tower Job Template component that you want to delete (example: "15").
#!               
#!               Output:
#!               
#!               No outputs are generated. 
#!
#! @input TemplateID: The ID (integrer) of the Ansible Tower Job Template component that you want to delete (example: "15").
#!!#
########################################################################################################################
    ...
    - Delete_Job_Template:
        do:
          io.cloudslang.base.http.http_client_delete:
            - url: "${get_sp('AnsibleTowerURL')+'/job_templates/'+TemplateID+'/'}"
            - auth_type: basic
