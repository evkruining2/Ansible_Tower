########################################################################################################################
#!!
#! @description: Delete a node in the Puppet Enterprise inventory.
#!
...
#! @input Certname: The name of the node (certificate) of the system to delete from the PE inventory. Example: pupnode1.example.com
#!
  ...
  graph:
    steps:
      ...
      delete_node:
        ...
        'y': 90
        navigate:
          2521bd62-734e-158c-ff3c-4292577cbfe9:
