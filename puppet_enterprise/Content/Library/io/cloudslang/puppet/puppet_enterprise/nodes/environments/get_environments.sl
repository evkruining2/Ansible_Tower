########################################################################################################################
#!!
#! @description: Get a list of Puppet Enterprise Environments
#!
...
#!
#! @output pe_environments: List of Puppet Enterprise Environments
#!!#
########################################################################################################################
namespace: io.cloudslang.puppet.puppet_enterprise.nodes.environments
flow:
    ...
    - get_environments:
        do:
          io.cloudslang.base.http.http_client_get:
            - url: "${PuppetEnterpriseURL+':4433/classifier-api/v1/environments'}"
        ...
        navigate:
          ...
          - FAILURE: on_failure
  outputs:
    - pe_environments: '${pe_environments}'
  results:
    - SUCCESS
    - FAILURE
extensions:
