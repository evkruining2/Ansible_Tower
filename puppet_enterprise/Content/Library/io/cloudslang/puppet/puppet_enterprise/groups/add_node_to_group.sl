########################################################################################################################
#!!
#! @description: Add a node to a group in Puppet Enterprise identified by the group_id
#!
...
#! @input node: The name of the certificate or node to add (pin) to the group. Example: pupnode2.example.com
#!
