########################################################################################################################
#!!
#! @description: Get the status of a PE job ("running", "failed", "finished", "errored")
#!
...
#! @input job_number: The job name or number to query the status
#!
#! @output job_status: List of Puppet Enterprise groups
#!!#
########################################################################################################################
  ...
  graph:
    steps:
      ...
      json_path_query:
        ...
        'y': 108
        navigate:
          b767171d-a8a2-60b5-c464-06199a7be316:
