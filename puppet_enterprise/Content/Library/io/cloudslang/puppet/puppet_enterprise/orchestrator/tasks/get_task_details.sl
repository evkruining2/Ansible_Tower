...
#!
#! @input PuppetEnterpriseTaskId: Puppet Enterprise Taks ID. Example: https://pemaster.example.com:8143/orchestrator/v1/tasks/service/init
...
#!
#! @output pe_task_details: List of Puppet Enterprise groups
#!!#
########################################################################################################################
